                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bg-light p-3 border">
                                        ...
                                        <div class="mb-0 d-flex align-items-center">
                                            ...
                                            <span class="ps-1 pb-1">{{ $job->salary }}</span>
                                        </div>
                                        @endif
                                    </div>
...
<script>
 ...
 $("#searchForm").submit(function(e){
    ...
    //job type find the with array of javascript
 ...
 var checkedJobTypes= $("input:checkbox[name='job_type']:checked").map(function(){
    ...
    //keyword agar blank hai to show karo
    ...
    //if user has checked selected job types
