        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-5">
                ...
                <div class="mt-4 text-center">
                    <p>Have an account? <a  href="{{ route('accout.login' ) }}">Login</a></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $("#registrationForm").submit(function(e){
        //not reload the form defalut
       e.preventDefault();

       $.ajax({
          url:'{{ route("accout.processRegistration") }}',
          type:'post',
          data: $("#registrationForm").serializeArray(),
          dataType:'json',
          success:function(response){

  //show the error for required the field
            ...
            if(response.status == false){
              ...
              if(errors.confirm_password){
                ...
                window.location.href='{{ route("accout.login") }}';
