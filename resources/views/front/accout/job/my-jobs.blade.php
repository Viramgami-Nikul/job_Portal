                    ...
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            ...
                            <div style="margin-top: -10px;">
                                <a href="{{ route('accout.createJob') }}" class="btn btn-primary">Post a Job</a>
                            </div>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('accout.editJob', $job->id) }}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
    ...
    function deleteJob(jobId){
        if(confirm("Are you sure you want to delete?")){
            ...
            $.ajax({
                ...
                url : ' {{ route ("accout.deleteJob")  }}',
                type: 'post',
                data: { jobId: jobId},
                dataType: 'json',
                success: function(response){
                    
                    window.location.href= '{{ route("accout.myJobs") }}';
                }
