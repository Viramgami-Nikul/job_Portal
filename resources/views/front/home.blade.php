<!-- declare the parent layout -->
 @extends('front.layouts.app')
 <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>


 <!-- declare the child layout for change the layout of main part -->
@section('main') 
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                ...
                <p>THOUNSANDS OF JOBS AVILABLE.</p>
                            ...
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="bg-light p-3 border">
                                        ...
                                        <!-- salary optional hai to null nahi hogi tabhi dikay degi -->
                          @if(!is_null($featuredJob ->salary))
                                        <p class="mb-0">
                                            {{-- <span class="fw-bolder"><i class="fa fa-indian-rupees"></i></span> --}}
                        <span class="fw-bolder"><i class='bx bx-rupee fs-5'></i></span>
